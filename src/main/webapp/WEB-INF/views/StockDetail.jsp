...
<link rel="stylesheet"
	href="<c:url value="/resources/css/StockManage/StockDetail.css" />" type="text/css">
...
<!-- Include content of this page  -->
					 <jsp:include page="pages/StockDetailContent.jsp"></jsp:include>
<!-- Include content of this page  -->
				</div>
	...
	<script src="<c:url value="/resources/js/StockManage/StockDetail.js" />"
		type="text/javascript"></script>
