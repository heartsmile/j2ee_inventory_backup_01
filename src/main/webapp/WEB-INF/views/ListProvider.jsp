...
<link rel="stylesheet"
	href="<c:url value="/resources/css/ProviderManage/ListProvider.css" />"
	type="text/css">
...
<body>
		...
		<div id="page-wrapper" style="min-height: 346px;">
			<div class="row">
				<div class="col-lg-12">
					...
					<jsp:include page="pages/ListProviderContent.jsp"></jsp:include>
					<!-- Include content of this page  -->
				</div>
	...
	<script src="<c:url value="/resources/js/ProviderManage/ListProvider.js" />"
		type="text/javascript"></script>
