...
<link rel="stylesheet"
	href="<c:url value="/resources/css/ProviderManage/ProviderDetail.css" />" type="text/css">
...
<!-- Include content of this page  -->
					 <jsp:include page="pages/ProviderDetailContent.jsp"></jsp:include>
<!-- Include content of this page  -->
				</div>
	...
	<script src="<c:url value="/resources/js/ProviderManage/ProviderDetail.js" />"
		type="text/javascript"></script>
